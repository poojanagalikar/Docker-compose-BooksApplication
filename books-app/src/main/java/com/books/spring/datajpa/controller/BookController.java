...
public class BookController {
	...
	public ResponseEntity<Book> updateBook(@PathVariable("id") long id, @RequestBody Book book) {
		Optional<Book> _bookData = bookRepository.findById(id);

		if (_bookData.isPresent()) {
			Book _book = _bookData.get();
			_book.setTitle(_book.getTitle());
			_book.setDescription(_book.getDescription());
			_book.setPublished(_book.isPublished());
